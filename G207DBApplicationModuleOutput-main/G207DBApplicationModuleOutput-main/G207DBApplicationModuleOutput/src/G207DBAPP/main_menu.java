    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (selection) {
                ...
                case 3:
                employee_management_menu emm = new employee_management_menu();
                    emm.menu();
                break;
                case 4: office_management_menu omm = new office_management_menu();
                omm.menu();
                break;
                ...
                case 7:
                    salesReportMenu01 srm01 = new salesReportMenu01();
                    srm01.menu();
                    break;
                case 8:
                    Salesreport02_menu srm2 = new Salesreport02_menu();
                    srm2.menu();
                    break;
